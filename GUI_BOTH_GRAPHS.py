...
class GUI:
    ...
    def __init__(self):
        ...
        self.indoor_temp_slider.grid(row=2, column=0, pady=(0, 5), sticky="W")
        ...
        button_frame.grid(row=4, column=0, columnspan=2, pady=(10, 10))  # Positioned just above the model parameters
        ...
        model_parameters_label.grid(row=5, column=0, columnspan=2, pady=(0, 10), sticky="W")
        ...
        for i, (label_text, unit) in enumerate(self.inputs):
            ...
            label.grid(row=i + 6, column=0, sticky="W", pady=(5, 5))
            
            entry = ctk.CTkEntry(input_frame)
            entry.grid(row=i + 6, column=1, pady=(5, 5), padx=(10, 0))
            
            # Initialize empty entry fields
            entry.insert(0, "") 
        ...
        self.execute_button.grid(row=len(self.inputs) + 6, column=0, columnspan=2, pady=(20,10))
        ...
        self.heat_button.grid(row=len(self.inputs) + 7, column=0, columnspan=2, pady=(10))
        
        # Clear Figure button
        self.clear_button = ctk.CTkButton(input_frame, text="Clear Figure", command=self.clear_figure, width=150)
        self.clear_button.grid(row=len(self.inputs) + 8, column=0, columnspan=2, pady=(10))

        # # Reset Inputs button
        self.reset_button = ctk.CTkButton(input_frame, text="Reset Inputs", command=self.reset_inputs, width=150)
        self.reset_button.grid(row=len(self.inputs) + 9, column=0, columnspan=2, pady=(10))
